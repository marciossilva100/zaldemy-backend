...
class FraseDoDia
{
    ...
    public static function obterFraseDoDia(PDO $pdo, OpenAiChat $chat, int $user_id, string $idiomaNome, string $idiomaNativoNome, array $phrases = [], ?string $nivelNome = null): array
    {
        ...
        $systemPrompt = "Você é um professor de idiomas escrevendo uma frase de exemplo em {$idiomaNome} pra um aluno "
            ...
            . "Revise mentalmente a frase final antes de responder pra garantir que ela é SEM REDUNDÂNCIA - nunca "
            . "use duas palavras/expressões diferentes fazendo o mesmo papel na mesma frase (ex: \"and then... "
            . "afterward\" repete a mesma ideia de sequência temporal duas vezes; o mesmo vale pra cortesia "
            . "duplicada, tipo \"please\" no início E no fim). Escolha só uma. Revise também o MODO VERBAL de cada "
            . "oração, não só o tempo, de acordo com as regras gramaticais PRÓPRIAS de {$idiomaNome} - erro comum "
            . "em línguas que têm modo subjuntivo: usar indicativo (futuro/presente) numa oração que a conjunção "
            . "exige subjuntivo. Exemplo do erro em português (só pra ilustrar o TIPO de erro, aplique a regra "
            . "equivalente de {$idiomaNome} se ela existir nesse idioma): depois de \"para que\", \"embora\", "
            . "\"caso\", \"a menos que\", o verbo tem que ir pro subjuntivo (\"para que você chegue lá\", NUNCA "
            . "\"para que você chegará lá\"). Se {$idiomaNome} não tiver esse conceito de modo subjuntivo, ignore "
            . "esse exemplo e revise só as regras de modo/tempo verbal que existem de fato nesse idioma. "
    ...
    public static function responder(
        ...
        $systemPrompt = "Você é um professor de idiomas avaliando a leitura em voz alta de um aluno. "
            ...
            . "idioma errado. IMPORTANTE: isso só vale quando a transcrição tem de fato PALAVRAS de outro idioma - "
            . "erro de pronúncia, hesitação, palavra trocada/omitida/mal reconhecida pelo transcritor de voz NÃO é a "
            . "mesma coisa que ler no idioma errado, mesmo que o resultado pareça estranho; nunca escreva no feedback "
            . "que o aluno \"leu no idioma errado\" ou \"não leu em {$idiomaNome}\" se a transcrição continua sendo "
            . "palavras de {$idiomaNome}, só mal pronunciadas/reconhecidas. Se estiver no idioma certo, divergências "
            . "entre a frase original e a transcrição podem indicar erro de pronúncia, palavra trocada/omitida ou "
            . "hesitação - avalie gramática, pronúncia (com base na divergência da transcrição) e fluência normalmente. "
